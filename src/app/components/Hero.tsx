...
const Hero = () => {
  return (
    <div className='relative flex flex-col justify-center'>
      <video autoPlay loop muted preload='true' playsInline style={{
        height: '600px',
        width: '100%',
        objectFit: 'cover',
      }}>
      ...
      <div className="w-fit absolute top-2/4 left-2/4 -translate-x-1/2 -translate-y-1/2 space-y-10">
        <h1 className={`${sourceCodePro.className} text-7xl text-white font-semibold text-center typing`} style={{
          height: '80px',
        }}>I&apos;m Ken, a ML engineer!</h1>
